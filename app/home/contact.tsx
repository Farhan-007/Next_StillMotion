      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-xl text-gray-400">
            Reach out to start your visual journey
          </p>
        ...
        >
          ...
          <FloatingInput id="message" label="Your Message" type="textarea" />
          
          {/* <div className="relative">
            <textarea
              id="message"
              className="w-full bg-transparent border-b-2 border-gray-700 focus:border-blue-400 pt-4 pb-2 px-2 text-white outline-none transition-colors"
              placeholder=" "
            />
            <label className="absolute left-2 top-4 text-gray-400 transition-all pointer-events-none">
              Your Message
            </label>
          </div> */}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-bold text-lg"
          >
            Send Message
          </motion.button>
        </motion.form>
...
//             body: data,
//           });
//           setSubmitMessage("Your message has been successfully sent!");
//         } catch (error) {
...
//                 <div>
//                   <label htmlFor="name" className="hidden sm:block leading-7 text-sm text-gray-400">
//                     Name
//                   </label>
//                   <input
//                     type="text"
...
//                 </div>
//                 <div>
//                   <label htmlFor="number" className="hidden sm:block leading-7 text-sm text-gray-400">
//                     Phone Number
//                   </label>
//                   <input
//                     type="tel"
...
//                 <label htmlFor="email" className="hidden sm:block leading-7 text-sm text-gray-400">
//                   Email
//                 </label>
//                 <input
//                   type="email"
...
//               </div>
//               <div className="relative mb-4">
//                 <label htmlFor="message" className="hidden sm:block leading-7 text-sm text-gray-400">
//                   Message
//                 </label>
//                 <textarea
//                   id="message"
...
//               <button
//                 type="submit"
//                 className="btn text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
//               >
